app.controller('projectController', ['$scope', '$location',
    'projectApiService', 'projectService', '$modal', '$window',
    function($scope, $location, projectApiService, projectService, $modal, $window) {
